...
public class MyList {
  ...
  /*
  - Hàm addLast cho object Bee
  - Hàm addLast theo input của đề (check điều kiện trong hàm này).
  */
 ...
 void addLast(Bee x){ //
  ...
  void f1() throws Exception { // Thường thì f1 không phải sửa gì.
    clear();
    loadData(1);
    String fname = "f1.txt";
  ...
  /*
  f2():
  - Viết hàm addAfterIndex().
  - Trong phần phải edit của f2() gọi lại addAfterIndex() kèm tham số theo đề bài .
  */
